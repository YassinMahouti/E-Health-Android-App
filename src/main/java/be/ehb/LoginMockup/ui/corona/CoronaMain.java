...
public class CoronaMain extends AppCompatActivity {
    ...
    public void init() {
        btn_saveAndCalculate = findViewById(R.id.btn_saveSymptoms);
        btn_showAllResults = findViewById(R.id.btn_calculateRisk);


        rd_groupFirst = findViewById(R.id.rd_group);
        rd_answerFirst_yes = findViewById(R.id.rd_First_yes);
        rd_answerFirst_no = findViewById(R.id.rd_first_no);

        rd_groupSecond = findViewById(R.id.rd_group2);
        rd_answerSec_yes = findViewById(R.id.rd_Sec_yes);
        rd_answerSec_no = findViewById(R.id.rd_Sec_no);

        rd_groupThird = findViewById(R.id.rd_group3);
        rd_answerThird_yes = findViewById(R.id.rd_Third_yes);
        rd_answerThird_no = findViewById(R.id.rd_Third_no);

        rd_groupFo = findViewById(R.id.rd_group4);
        rd_answerFo_yes = findViewById(R.id.rd_Fo_yes);
        rd_answerFo_no = findViewById(R.id.rd_Fo_no);

        rd_groupFi = findViewById(R.id.rd_group5);
        rd_answerFi_yes = findViewById(R.id.rd_Fif_yes);
        rd_answerFi_no = findViewById(R.id.rd_Fif_no);

        rd_groupSix = findViewById(R.id.rd_group6);
        rd_answerSix_yes = findViewById(R.id.rd_Six_yes);
        rd_answerSix_no = findViewById(R.id.rd_Six_no);

        rd_groupSeven = findViewById(R.id.rd_group7);
        rd_answerSeven_yes = findViewById(R.id.rd_Seven_yes);
        rd_answerSeven_no = findViewById(R.id.rd_Seven_no);
    }

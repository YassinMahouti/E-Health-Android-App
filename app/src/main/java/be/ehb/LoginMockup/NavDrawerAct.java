...
public class NavDrawerAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home,R.id.nav_drink_water ,R.id.nav_bmi_bfp,R.id.nav_foodlookup,R.id.nav_find_place, R.id.nav_am_i_sick,R.id.nav_drink_water,R.id.nav_barcode,R.id.nav_stepcounter,R.id.nav_bmi_bfp,R.id.nav_movement_monitor)
